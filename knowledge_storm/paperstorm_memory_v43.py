...
class MemoryRecordV43(BaseModel):
...
class MemoryCandidateV43(BaseModel):
    memory_type: MemoryType
    subject: str
    content: str
    canonical_key: str
...
class MemoryWritePolicy:
    ...
    def extract(message: str, source_message_id: str = "", subject: str = "user"):
        ...
        return MemoryCandidateV43(
            ...
            metadata={"extractor": "deterministic_policy_v43", "explicit": explicit},
        )
